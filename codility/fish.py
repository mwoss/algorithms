...
Fish number P is represented by A[P] and B[P]. Array A contains the sizes of the fish. All its elements are unique. A
rray B contains the directions of the fish. It contains only 0s and/or 1s, where:
...
def solution(A, B):
    # A - list of fishes weight, B - directions
    downstream = []
    fish_num = len(A)
    upstream_survived = 0
    ...
    return upstream_survived + len(downstream)


if __name__ == '__main__':
    print(solution([4, 3, 2, 1, 5], [0, 0, 1, 0, 0]))
