...
The height of the wall is specified by an array H of N positive integers. H[I] is the height of the wall from I
to I+1 meters to the right of its left end. In particular, H[0] is the height of the wall's left end and H[N−1]
...
def solution(H):
    ...
    for i in range(1, len(H)):
        ...
        if H[i] > stack[-1] or not stack:  # if new element is higher than previous
            stack.append(H[i])
            blocks += 1
